                        ...
                        children: [
                          Flexible(
                            child: Text(
                              ...
                              style: TextStyle(fontSize: unitHeightValue * 0.024, fontWeight: FontWeight.bold),
                            ),
                          )
                        ]
                      ),
                    ...
                    Container (
                      ...
                      child: Row(
                        children: [
                          Flexible(
                            child: Text(
                              widget.productOffer['productOfferDescription'] ?? '',
                              style: TextStyle(fontSize: unitHeightValue * 0.018),
                            ),
                          )
                        ]
                      ),
